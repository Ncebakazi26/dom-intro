...
RadioInst.smsAndcalls1(billItemType)
    ...
    callTotalTwo1.innerHTML = RadioInst.getcallTotal1().toFixed(2);
    smsTotalTwo1.innerHTML = RadioInst.getsmsTotal1().toFixed(2);
    TotalTwo1.innerHTML = RadioInst.getTotal1().toFixed(2);
